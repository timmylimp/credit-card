namespace CreditCard.RestAPI.DataContext.CreditCardMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CreditCard.RestAPI.DataContext.CreditCardDb>
    {
        ...
        protected override void Seed(CreditCard.RestAPI.DataContext.CreditCardDb context)
        {
            ...
            var cards = new Card[] {
                new Card { Id = 1, CardNumber = "4111111111111111" }, // Visa
                new Card { Id = 2, CardNumber = "5111111111111111" }, // MasterCard
                new Card { Id = 3, CardNumber = "311111111111111" },  // Amex
                new Card { Id = 4, CardNumber = "3222222222222222" }, // JCB
                new Card { Id = 5, CardNumber = "6111111111111111" }  // Unknown
            };
